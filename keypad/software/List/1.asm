...
; 0000 0027 int index_x = 0, index_y = 0;
...
; 0000 003C // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 003D // State7=T State6=T State5=T State4=T State3=0 State2=0 State1=0 State0=0
...
; 0000 004D // Mode: Normal top=FFFFh
...
; 0000 0079 SFIOR=0x00;
	...
	OUT  0x30,R30
; 0000 007A 
; 0000 007B // LCD module initialization
...
; 0000 007D lcd_clear();
	CALL _lcd_clear
; 0000 007E lcd_gotoxy(index_x,index_y);
	ST   -Y,R16
	ST   -Y,R18
	CALL _lcd_gotoxy
; 0000 007F //lcd_putsf("hh");
; 0000 0080 
; 0000 0081 while (1)
_0x3:
; 0000 0082       {
...
; 0000 0084         PORTD.0 = 1;
	SBI  0x12,0
; 0000 0085         delay_ms(20);
	CALL SUBOPT_0x0
; 0000 0086 
; 0000 0087         if(PIND.4 == 1)
	SBIS 0x10,4
	RJMP _0x8
; 0000 0088         {
; 0000 0089             while(PIND.4 == 1);
_0x9:
	SBIC 0x10,4
	RJMP _0x9
; 0000 008A             lcd_putchar('7');
	LDI  R30,LOW(55)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 008B 
...
_0x8:
	...
	RJMP _0xC
; 0000 008E         {
; 0000 008F             while(PIND.5 == 1);
_0xD:
	SBIC 0x10,5
	RJMP _0xD
; 0000 0090             lcd_putchar('8');
	LDI  R30,LOW(56)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 0091         }
; 0000 0092         if(PIND.6 == 1)
_0xC:
	SBIS 0x10,6
	RJMP _0x10
; 0000 0093         {
; 0000 0094             while(PIND.6 == 1);
_0x11:
	SBIC 0x10,6
	RJMP _0x11
; 0000 0095             lcd_putchar('9');
	LDI  R30,LOW(57)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 0096         }
; 0000 0097         if(PIND.7 == 1)
_0x10:
	SBIS 0x10,7
	RJMP _0x14
; 0000 0098         {
; 0000 0099             while(PIND.7 == 1);
_0x15:
	SBIC 0x10,7
	RJMP _0x15
...
; 0000 009E         PORTD.1 = 1;
	SBI  0x12,1
; 0000 009F         if(PIND.4 == 1)
	SBIS 0x10,4
	RJMP _0x1C
; 0000 00A0         {
; 0000 00A1             while(PIND.4 == 1 );
_0x1D:
	SBIC 0x10,4
	RJMP _0x1D
; 0000 00A2             lcd_putchar('4');
	LDI  R30,LOW(52)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 00A3         }
; 0000 00A4         if(PIND.5 == 1)
_0x1C:
	SBIS 0x10,5
	RJMP _0x20
; 0000 00A5         {
; 0000 00A6             while(PIND.5 == 1);
_0x21:
	SBIC 0x10,5
	RJMP _0x21
; 0000 00A7             lcd_putchar('5');
	LDI  R30,LOW(53)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 00A8         }
; 0000 00A9         if(PIND.6 == 1)
_0x20:
	SBIS 0x10,6
	RJMP _0x24
; 0000 00AA         {
; 0000 00AB             while(PIND.6 == 1);
_0x25:
	SBIC 0x10,6
	RJMP _0x25
; 0000 00AC             lcd_putchar('6');
	LDI  R30,LOW(54)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 00AD         }
; 0000 00AE         if(PIND.7 == 1)
_0x24:
	SBIS 0x10,7
	RJMP _0x28
; 0000 00AF         {
; 0000 00B0             while(PIND.7 == 1);
_0x29:
	SBIC 0x10,7
	RJMP _0x29
...
_0x28:
	CBI  0x12,1
; 0000 00B4         delay_ms(20);
	CALL SUBOPT_0x0
; 0000 00B5         PORTD.2 = 1;
	SBI  0x12,2
; 0000 00B6         if(PIND.4 == 1)
	SBIS 0x10,4
	RJMP _0x30
; 0000 00B7         {
; 0000 00B8             while(PIND.4 == 1);
_0x31:
	SBIC 0x10,4
	RJMP _0x31
; 0000 00B9             lcd_putchar('1');
	...
	CALL _lcd_putchar
; 0000 00BA         }
; 0000 00BB         if(PIND.5 == 1)
_0x30:
	SBIS 0x10,5
	RJMP _0x34
; 0000 00BC         {
; 0000 00BD             while(PIND.5 == 1);
_0x35:
	SBIC 0x10,5
	RJMP _0x35
; 0000 00BE             lcd_putchar('2');
	LDI  R30,LOW(50)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 00BF         }
; 0000 00C0         if(PIND.6 == 1)
_0x34:
	SBIS 0x10,6
	RJMP _0x38
; 0000 00C1         {
; 0000 00C2             while(PIND.6 == 1);
_0x39:
	SBIC 0x10,6
	RJMP _0x39
; 0000 00C3             lcd_putchar('3');
	LDI  R30,LOW(51)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 00C4         }
; 0000 00C5         if(PIND.7 == 1)
_0x38:
	SBIS 0x10,7
	RJMP _0x3C
; 0000 00C6         {
; 0000 00C7             while(PIND.7 == 1);
_0x3D:
	SBIC 0x10,7
	RJMP _0x3D
...
; 0000 00CC         PORTD.3 = 1;
	SBI  0x12,3
; 0000 00CD         if(PIND.4 == 1)
	SBIS 0x10,4
	RJMP _0x44
; 0000 00CE         {
; 0000 00CF             while(PIND.4 == 1);
_0x45:
	SBIC 0x10,4
	RJMP _0x45
; 0000 00D0             //lcd_putchar('7');
; 0000 00D1             lcd_clear();
	CALL _lcd_clear
; 0000 00D2             lcd_gotoxy(0,0);
	...
	CALL _lcd_gotoxy
; 0000 00D3         }
; 0000 00D4         if(PIND.5 == 1)
_0x44:
	SBIS 0x10,5
	RJMP _0x48
; 0000 00D5         {
; 0000 00D6             while(PIND.5 == 1);
_0x49:
	SBIC 0x10,5
	RJMP _0x49
; 0000 00D7             lcd_putchar('0');
	LDI  R30,LOW(48)
	ST   -Y,R30
	CALL _lcd_putchar
; 0000 00D8         }
; 0000 00D9         if(PIND.6 == 1)
_0x48:
	SBIS 0x10,6
	RJMP _0x4C
; 0000 00DA         {
; 0000 00DB             while(PIND.6 == 1);
_0x4D:
	SBIC 0x10,6
	RJMP _0x4D
; 0000 00DC             lcd_putchar('=');
	...
	CALL _lcd_putchar
; 0000 00DD         }
; 0000 00DE         if(PIND.7 == 1)
_0x4C:
	SBIS 0x10,7
	RJMP _0x50
; 0000 00DF         {
; 0000 00E0             while(PIND.7 == 1);
_0x51:
	SBIC 0x10,7
	RJMP _0x51

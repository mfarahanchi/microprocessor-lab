...
; 0000 0026 CLKPR=0x80;
	LDI  R30,LOW(128)
	STS  97,R30
; 0000 0027 CLKPR=0x00;
	LDI  R30,LOW(0)
	STS  97,R30
...
; 0000 004E PORTF=0x00;
	OUT  0x11,R30
; 0000 004F DDRF=0x00;
	OUT  0x10,R30
; 0000 0050 
; 0000 0051 // Port G initialization
; 0000 0052 // Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 0053 // State5=T State4=T State3=T State2=T State1=T State0=T
; 0000 0054 PORTG=0x00;
	OUT  0x14,R30
; 0000 0055 DDRG=0x00;
	OUT  0x13,R30
; 0000 0056 
; 0000 0057 // Port H initialization
...
; 0000 005A PORTH=0x00;
	STS  258,R30
; 0000 005B DDRH=0x00;
	STS  257,R30
; 0000 005C 
; 0000 005D // Port J initialization
...
; 0000 0060 PORTJ=0x00;
	STS  261,R30
; 0000 0061 DDRJ=0x00;
	STS  260,R30
; 0000 0062 
; 0000 0063 // Port K initialization
...
; 0000 0066 PORTK=0x00;
	STS  264,R30
; 0000 0067 DDRK=0x00;
	STS  263,R30
; 0000 0068 
; 0000 0069 // Port L initialization
...
; 0000 0081         lcd_clear();
	RCALL SUBOPT_0x0
; 0000 0082         lcd_gotoxy(i, 0);
; 0000 0083         lcd_putchar('I');
; 0000 0084         lcd_putchar('U');
; 0000 0085         lcd_putchar('S');
; 0000 0086         lcd_putchar('T');
; 0000 0087         if(i == 12){
	LDI  R30,LOW(12)
	LDI  R31,HIGH(12)
	CP   R30,R5
...
; 0000 008F         lcd_clear();
	RCALL SUBOPT_0x0
; 0000 0090         lcd_gotoxy(i, 0);
; 0000 0091         lcd_putchar('I');
; 0000 0092         lcd_putchar('U');
; 0000 0093         lcd_putchar('S');
; 0000 0094         lcd_putchar('T');
; 0000 0095         if(i == 0){
	MOV  R0,R5
	OR   R0,R6
	BRNE _0xF
